...
class ConcertsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create concert" do
    assert_difference('Concert.count') do
      post concerts_url, params: { concert: { assitants: @concert.assitants, datetime: @concert.datetime, duration: @concert.duration } }
    end
  ...
  test "should update concert" do
    patch concert_url(@concert), params: { concert: { assitants: @concert.assitants, datetime: @concert.datetime, duration: @concert.duration } }
